<?php
$infoAdmin = $this->session->userdata('admin');
$id = $infoAdmin['id'];
$user_name = $infoAdmin['user_name'];
?>
<!DOCTYPE html>
<html lang="vi">
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/admin">
                ...
                <div class="sidebar-brand-text mx-3">SmartID365</div>
            </a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <!-- <button type="button" class="btn btn-primary btn_logout">Đăng xuất</button> -->
                    <a class="btn btn-primary" href="/Admin/Views/Admin/logout">Đăng xuất</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="/assets/admin/js/admin/jquery.tableToExcel.js"></script>
    ...
    <script src="/assets/admin/js/admin/home.js"></script>  -->
    <?php
    if (isset($js)) {
        foreach ($js as $val) {
    ?>
