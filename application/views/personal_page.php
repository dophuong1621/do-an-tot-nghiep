<div class="personal_page">
  <div class="cover_image">
    ...
    <div class="k_absolute">
      <div class="k_bia">
        <img src="/assets/avata_user/<?= ($prof->avatar != '') ? "$prof->avatar" : "user.png" ?>" alt="Ảnh đại diện" class="img_avata">
          ...
          if (empty($contact)) {
            ...
            foreach ($contact as $item) {
              ...
              if ($type == 16) {
                ...
                // $typeA16 = '
                // </a><div class="btn_hide k_none btn_cn">
                // <button class="btn_none edit_ttcn"><img src="/assets/images/edit_2.svg" alt="Chỉnh sửa" class="icon_edit_2"></button>
                // <button class="btn_none dlt_ttcn btn_dlt2" onclick="delContact()"><img src="/assets/images/dlt.svg" alt="Xóa" class="icon_delCont"></button>
                // </div>
                // </div>';
              ...
              echo '
              ' . $linkBank . '<div class="k_tab1 d-flex align-items-center justify-content-between contact" data-id="' . $item['id'] . '" data-link-id="' . $item['type'] . '">
